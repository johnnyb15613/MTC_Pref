...
class DialogUtils {
    ...
    fun recheckThemeColor(context: Context, isPortrait: Boolean, portraitContainer: TableLayout, landscapeContainer: LinearLayout) {
        ...
        val colors: IntArray = ColorUtils().getColorSet(themeName.toString(), context, true)
    ...
    fun recheckAccentColor(context: Context, accentContainer: LinearLayout) {
        ...
        val accentName = PrefUtils.getAccentColor(context)

        val colors = ColorUtils().getColorSet(themeName.toString(), context, true)
    ...
    fun getAccentItem(context: Context, themeName: String): CardView {
        ...
        // no splitting needed
        val thna: String? = PrefUtils.getThemeColor(context)
        val colors: IntArray = ColorUtils().getColorSet(thna.toString(), context, true)
        ...
        if (PrefUtils.getThemeHue(context)) {
            loadDrawable(
                context,
                VIEW_CHECKED.toString() + themeName,
                checked,
     ...
     */
    fun loadDrawable(context: Context, title: String, imageView: ImageView, id: Int, color: Int) {
